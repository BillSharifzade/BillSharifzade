...
<sub><code>Rust</code> · <code>hyper</code> · <code>Tokio</code> · <code>proc-macros</code></sub>
...
<sub><code>Python</code> · <code>RAG</code> · <code>RBAC</code> · <code>Ollama / Claude</code></sub>
...
<sub><code>Rust</code> · <code>Axum</code> · <code>SQLx</code> · <code>PostgreSQL</code> · <code>Next.js</code> · <code>OpenAI</code></sub>
...
<sub><code>Go</code> · <code>chi</code> · <code>PostgreSQL</code> · <code>React</code> · <code>TypeScript</code></sub>
...
<sub><code>Python</code> · <code>FastAPI</code> · <code>aiogram</code> · <code>React</code> · <code>PostgreSQL</code></sub>
...
<sub><code>React</code> · <code>Vite</code> · <code>GSAP</code> · <code>react-pdf</code></sub>
...
<table align="center">
<tr>
<td align="center" valign="top" width="25%"><h2>50–70×</h2><sub>latency &amp; throughput gain on the Smart City platform, every change load-tested against production with Grafana k6</sub></td>
<td align="center" valign="top" width="25%"><h2>~1000×</h2><sub>faster regulatory reporting for a micro-credit engine: multi-day manual compilation down to minutes</sub></td>
<td align="center" valign="top" width="25%"><h2>10+</h2><sub>large-scale systems automating core business processes for enterprise clients</sub></td>
<td align="center" valign="top" width="25%"><h2>80%</h2><sub>less manual work for those clients, and hiring cut from days to hours with AI-driven screening</sub></td>
</tr>
</table>
...
<sub>What I actually reach for: **Rust** with Axum, Actix, Tokio, Tauri and Ratatui · **Go** with chi and pgx · **Python** with FastAPI, Django, NumPy/Pandas and TensorFlow · **C** with OpenGL and Vulkan, plus Zig and Assembly when it matters · **Linux** all the way down: Arch, Gentoo and Kali, the kernel, systemd, syscalls.</sub>
...
<picture>
  ...
  <img src="assets/stats-dark.svg" alt="GitHub activity: contributions, repos, stars, followers, streaks and language breakdown" width="100%">
</picture>
...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/BillSharifzade/BillSharifzade/output/github-snake.svg" alt="Contribution graph, eaten by a snake" width="100%">
</picture>

<sub>Both graphics are rendered by workflows in this repo, so they never depend on a rate-limited third-party service.</sub>
...
<sub>The full CV, downloadable in several formats, lives at <a href="https://billsharifzade.github.io/">billsharifzade.github.io</a>. Always happy to talk systems, Rust, or hard problems — pick any channel above.</sub>

<br><br>

<img src="https://komarev.com/ghpvc/?username=BillSharifzade&color=818cf8&style=flat-square&label=profile+views" alt="Profile views">
